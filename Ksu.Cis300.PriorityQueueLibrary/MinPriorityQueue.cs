...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// Returns the minumum priority value at the root, and it removes it from the tree by
        /// creating a new tree using the method merge.
        /// </summary>
        /// <returns>The value stored at the minimum value.</returns>
